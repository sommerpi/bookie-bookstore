...
def get_selected_row(event):
  try:
    ...
    # display the info of selected row in entries
    e1.delete(0, END)
...
def view_command():
  list1.delete(0, END)  # clear the rows every time "View all" is clicked
  for row in backend.view():
    list1.insert(END,row)  # ensure the new row is inserted at the end
...
"""
Configure list box and scroll bar
"""
